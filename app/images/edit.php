        ...
        <form action="" method="post" class="col s12">
            <div class="row">
                <div class="file-field input-field col s12">
                    ...
                    <input id="image_photo" name="image_photo" value=<?php $imageView->printImagePhoto() ?> type="url"
                           class="validate" length="767">
...
<script>
    $(document).ready(function () {
        $('#image_description').val('<?php $imageView->printImageDescription() ?>');
        $('#image_description').trigger('autoresize');

        $('#image_comments').val('<?php $imageView->printImageComments() ?>');
